...
export const pt_BR: TranslationMap = {
  ...
  browser: {
    ...
    urlPlaceholder: "Insira uma URL e pressione Enter",
    dockBottom: "Encaixar na parte inferior",
    dockRight: "Encaixar à direita",
    ...
    annotateHint: "Desenhe na página e, em seguida, envie a marcação para seu chat.",
    ...
    empty: "Nenhuma aba aberta. Insira um URL acima para navegar.",
