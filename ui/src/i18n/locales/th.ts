...
export const th: TranslationMap = {
  ...
  browser: {
    ...
    dockRight: "ยึดไว้ด้านขวา",
    annotate: "ใส่คำอธิบายประกอบบนหน้า",
    inspect: "ตรวจสอบองค์ประกอบ",
    annotateSend: "ส่งไปยังแชท",
    annotateUndo: "เลิกทำ",
    annotateClear: "ล้าง",
    annotateDone: "ออกจากโหมดใส่คำอธิบายประกอบ",
    annotateHint: "วาดบนหน้าเว็บ แล้วส่งมาร์กอัปไปยังแชตของคุณ",
    inspectHint: "วางเมาส์เพื่อ inspect; คลิกเพื่อส่งองค์ประกอบไปยังแชตของคุณ",
    inspectName: "ชื่อ",
    inspectRole: "บทบาท",
    inspectFocusable: "โฟกัสได้",
    loading: "กำลังโหลดหน้า…",
    starting: "กำลังเริ่มเบราว์เซอร์…",
    notRunning: "เบราว์เซอร์ Gateway ไม่ได้ทำงานอยู่",
    start: "เริ่มเบราว์เซอร์",
    empty: "ไม่มีแท็บที่เปิดอยู่ ป้อน URL ด้านบนเพื่อเรียกดู",
    refresh: "รีเฟรชมุมมอง",
    noChatTarget: "เปิดเซสชันแชตก่อน เพื่อให้คำอธิบายประกอบมีที่ให้ส่งไป",
    inspectUnavailable: "การตรวจสอบองค์ประกอบถูกปิดใช้งาน (browser.evaluateEnabled=false)",
    annotationSent: "เพิ่มคำอธิบายประกอบไปยังช่องเขียนแชตแล้ว",
    annotatePrompt: {
      introTitled:
        'ฉันได้ใส่คำอธิบายประกอบในหน้าที่ {url} (ชื่อเรื่องที่หน้ารายงาน: "{title}") — ภาพหน้าจอที่แนบมาแสดงมาร์กอัปของฉัน',
      introUntitled: "ฉันได้ใส่คำอธิบายประกอบบนหน้าเว็บที่ {url} — ภาพหน้าจอที่แนบมาแสดงมาร์กอัปของฉัน",
      region:
        "บริเวณที่ทำเครื่องหมาย {index}: อยู่กึ่งกลางประมาณ {x}% จากซ้าย / {y}% จากบน ครอบคลุมประมาณ {width}% × {height}% ของมุมมอง",
      moreRegions: "…รวมถึงบริเวณที่ทำเครื่องหมายอีก {count} รายการ ซึ่งทั้งหมดมองเห็นได้ในภาพหน้าจอ",
      elementDetail:
        "องค์ประกอบที่ทำเครื่องหมายไว้ (ตามที่หน้ารายงาน): {descriptor} — {width}×{height}px ที่ ({x}, {y})",
      outro: "โปรดดูบริเวณที่ทำเครื่องหมายไว้ แล้วบอกฉันว่าคุณคิดเห็นอย่างไร",
    },
  },
  tabs: {
    agents: "เอเจนต์",
