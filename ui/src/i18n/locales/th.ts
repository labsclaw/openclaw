...
export const th: TranslationMap = {
  ...
  browser: {
    ...
    annotatePrompt: {
      intro: 'ฉันได้ใส่คำอธิบายประกอบบนหน้าเว็บที่ {url} ("{title}") — ภาพหน้าจอที่แนบมาแสดงมาร์กอัปของฉัน',
      ...
      element: "องค์ประกอบที่ทำเครื่องหมาย: {descriptor} — {width}×{height}px ที่ ({x}, {y})",
