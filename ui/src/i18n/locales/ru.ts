...
export const ru: TranslationMap = {
  ...
  browser: {
    ...
    noChatTarget: "Сначала откройте сеанс чата, чтобы было куда отправить аннотацию.",
    inspectUnavailable: "Инспекция элементов отключена (browser.evaluateEnabled=false).",
    annotationSent: "Аннотация добавлена в поле ввода чата.",
    annotatePrompt: {
      introTitled:
        'Я разметил страницу по адресу {url} (заголовок, сообщенный страницей: "{title}") — на приложенном скриншоте показана моя разметка.',
      introUntitled:
        "Я добавил аннотацию к странице по адресу {url} — на прикрепленном снимке экрана видна моя разметка.",
      region:
        "Отмеченная область {index}: центр примерно в {x}% по горизонтали / {y}% по вертикали, занимает около {width}% × {height}% области просмотра.",
      moreRegions: "…плюс еще {count} отмеченных областей, все они видны на снимке экрана.",
      elementDetail:
        "Отмеченный элемент (сообщенный страницей): {descriptor} — {width}×{height}px в точке ({x}, {y}).",
      outro: "Посмотрите, пожалуйста, на отмеченную область и скажите, что вы об этом думаете.",
    },
  },
  tabs: {
    agents: "Агенты",
