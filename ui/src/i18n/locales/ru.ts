...
export const ru: TranslationMap = {
  ...
  browser: {
    ...
    annotatePrompt: {
      intro:
        'Я добавил аннотацию к странице по адресу {url} ("{title}") — на прикрепленном снимке экрана видна моя разметка.',
      introUntitled:
      ...
      element: "Отмеченный элемент: {descriptor} — {width}×{height}px в точке ({x}, {y}).",
