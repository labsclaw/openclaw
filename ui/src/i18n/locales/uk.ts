...
export const uk: TranslationMap = {
  ...
  browser: {
    ...
    annotatePrompt: {
      intro:
        'Я додав анотацію на сторінці за адресою {url} ("{title}") — на прикріпленому знімку екрана показано мою розмітку.',
      introUntitled:
      ...
      element: "Позначений елемент: {descriptor} — {width}×{height}px у точці ({x}, {y}).",
