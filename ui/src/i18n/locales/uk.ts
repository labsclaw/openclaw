...
export const uk: TranslationMap = {
  ...
  browser: {
    ...
    urlPlaceholder: "Введіть URL-адресу й натисніть Enter",
    ...
    annotateDone: "Вийти з режиму анотацій",
    annotateHint: "Намалюйте на сторінці, а потім надішліть розмітку до свого чату.",
    inspectHint: "Наведіть курсор, щоб перевірити; клацніть, щоб надіслати елемент до свого чату.",
    inspectName: "Назва",
    inspectRole: "Роль",
    ...
    inspectUnavailable: "Перевірку елементів вимкнено (browser.evaluateEnabled=false).",
    annotationSent: "Анотацію додано до редактора повідомлення чату.",
    annotatePrompt: {
      introTitled:
        'Я анотував сторінку за адресою {url} (заголовок, повідомлений сторінкою: "{title}") — прикріплений знімок екрана показує мою розмітку.',
      introUntitled:
        "Я додав анотацію на сторінці за адресою {url} — на прикріпленому знімку екрана показано мою розмітку.",
      region:
      ...
      elementDetail:
        "Позначений елемент (повідомлений сторінкою): {descriptor} — {width}×{height}px у точці ({x}, {y}).",
