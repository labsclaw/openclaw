...
export const ar: TranslationMap = {
  ...
  browser: {
    ...
    dockBottom: "تثبيت في الأسفل",
    dockRight: "تثبيت إلى اليمين",
    annotate: "إضافة تعليقات توضيحية إلى الصفحة",
    inspect: "فحص العنصر",
    annotateSend: "إرسال إلى الدردشة",
    annotateUndo: "تراجع",
    annotateClear: "مسح",
    annotateDone: "الخروج من وضع التعليقات التوضيحية",
    annotateHint: "ارسم على الصفحة، ثم أرسل العلامات إلى محادثتك.",
    ...
    start: "بدء المتصفح",
    empty: "لا توجد تبويبات مفتوحة. أدخل عنوان URL أعلاه للتصفح.",
    refresh: "تحديث العرض",
