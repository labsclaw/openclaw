...
export const ja_JP: TranslationMap = {
  ...
  browser: {
    title: "ブラウザー",
    toggle: "ブラウザーパネルを切り替え",
    hide: "ブラウザーパネルを非表示",
    resize: "ブラウザーパネルのサイズを変更",
    newTab: "新しいタブ",
    closeTab: "タブを閉じる",
    untitledTab: "新しいタブ",
    back: "戻る",
    forward: "進む",
    reload: "再読み込み",
    openExternal: "お使いのブラウザーで開く",
    urlPlaceholder: "URL を入力して Enter キーを押す",
    dockBottom: "下部にドッキング",
    dockRight: "右側にドッキング",
    annotate: "ページに注釈を付ける",
    inspect: "要素を検証",
    ...
    loading: "ページを読み込み中…",
    starting: "ブラウザを起動中…",
    notRunning: "Gateway ブラウザは実行されていません。",
    start: "ブラウザを起動",
    empty: "開いているタブがありません。閲覧するには上に URL を入力してください。",
    refresh: "ビューを更新",
