...
export const vi: TranslationMap = {
  ...
  browser: {
    ...
    resize: "Đổi kích thước bảng trình duyệt",
    newTab: "Thẻ mới",
    closeTab: "Đóng thẻ",
    untitledTab: "Thẻ mới",
    back: "Quay lại",
    ...
    urlPlaceholder: "Nhập URL và nhấn Enter",
    ...
    annotateHint: "Vẽ trên trang, rồi gửi phần đánh dấu vào cuộc trò chuyện của bạn.",
    inspectHint: "Di chuột để kiểm tra; nhấp để gửi phần tử vào cuộc trò chuyện của bạn.",
    inspectName: "Tên",
    inspectRole: "Vai trò",
    inspectFocusable: "Có thể lấy tiêu điểm",
    ...
    empty: "Không có tab nào đang mở. Nhập URL ở trên để duyệt.",
    refresh: "Làm mới chế độ xem",
    noChatTarget: "Hãy mở một phiên trò chuyện trước để chú thích có nơi được gửi đến.",
